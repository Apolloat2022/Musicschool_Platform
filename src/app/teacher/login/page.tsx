            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <div className="flex justify-center mb-5">
                        <div className="p-4 bg-amber-500/10 rounded-2xl border border-amber-500/20 shadow-inner text-amber-500">
                            <Briefcase size={40} />
                        </div>
                    </div>
                    <h1 className="text-3xl font-bold text-white tracking-tight mb-2">Teacher Portal</h1>
                    <p className="text-slate-400 text-sm">Sign in to manage your classes and students.</p>
                </div>
                ...
                <div className="flex justify-center">
                    <SignIn
                        routing="hash"
                        afterSignInUrl="/faculty/dashboard"
                        appearance={{
                            variables: {
                                colorPrimary: "#f59e0b",
                            ...
                            elements: {
                                ...
                                formButtonPrimary: "bg-amber-600 hover:bg-amber-500",
                ...
                <div className="mt-8 flex flex-col items-center gap-3 text-sm text-slate-600">
                    ...
                    <div className="flex gap-4">
                        <Link href="/student/login" className="text-slate-500 hover:text-indigo-400 font-semibold transition-colors">Student Login</Link>
