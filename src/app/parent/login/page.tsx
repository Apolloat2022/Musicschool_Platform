            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <div className="flex justify-center mb-5">
                        <div className="p-4 bg-emerald-500/10 rounded-2xl border border-emerald-500/20 shadow-inner text-emerald-500">
                            <Users size={40} />
                        </div>
                    </div>
                    <h1 className="text-3xl font-bold text-white tracking-tight mb-2">Parent Portal</h1>
                    <p className="text-slate-400 text-sm">Sign in to monitor progress and manage enrollments.</p>
                </div>
